...
export default function RequestsAdminPage() {
    ...
    const fetchRequests = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://www.mobitel.in'}/api/requests`);
    ...
    const handleUpdateStatus = async (id, newStatus) => {
        setUpdating(id);
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://www.mobitel.in'}/api/requests/${id}`, {
                method: "PUT",
