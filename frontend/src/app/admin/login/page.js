...
export default function AdminLogin() {
    ...
    useEffect(() => {
        ...
        if (token) {
            ...
            fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://www.mobitel.in'}/api/admin/verify`, {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://www.mobitel.in'}/api/admin/login`, {
                method: "POST",
