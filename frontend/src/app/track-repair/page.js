                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-500">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                            ...
                            <div className="lg:col-span-5 space-y-6">
                                ...
                                {/* Shop Location (for Shop Visit bookings) */}
                                {repair.shopDetails && (
                                    <div className="bg-white rounded-3xl border border-gray-100 shadow-xl shadow-gray-200/40 overflow-hidden">
                                        <div className="bg-gradient-to-r from-orange-50 to-white px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                                            ...
                                            <h3 className="font-bold text-dark text-lg">Shop Location</h3>
                                        </div>
                                        <div className="p-6 space-y-4">
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    <p className="font-bold text-dark text-sm">{repair.shopDetails.name}</p>
                                                    <p className="text-muted text-sm mt-1 leading-relaxed">{repair.shopDetails.address}</p>
                                                </div>
                                            </div>
                                            {repair.shopDetails.contact && (
                                                <a href={`tel:${repair.shopDetails.contact}`} className="flex items-center gap-3 bg-green-50 hover:bg-green-100 p-3 rounded-xl transition-colors group">
                                                    <div className="w-8 h-8 bg-green-100 group-hover:bg-green-200 rounded-lg flex items-center justify-center shrink-0 transition-colors">
                                                        <svg className="w-4 h-4 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                                        </svg>
                                                    </div>
                                                    <div>
                                                        <p className="text-xs font-semibold text-green-700 uppercase tracking-wider">Call Shop</p>
                                                        <p className="font-bold text-green-800 text-sm">{repair.shopDetails.contact}</p>
                                                    </div>
                                                </a>
                                            )}
                                            <a
                                                href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(repair.shopDetails.address)}`}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="flex items-center justify-center gap-2 w-full bg-primary/10 hover:bg-primary/20 text-primary font-bold py-3 px-4 rounded-xl transition-colors text-sm"
                                            >
                                ...
                                <div className="relative overflow-hidden bg-gradient-to-br from-dark to-[#1a1d24] rounded-3xl p-6 sm:p-8 text-white shadow-2xl">
                                    ...
                                    <div className="relative z-10 flex flex-col items-center text-center">
                                        ...
                                        <a href="tel:+918287853207" className="inline-flex items-center justify-center gap-2 w-full bg-white text-dark font-bold py-3.5 px-6 rounded-xl hover:bg-gray-100 active:scale-95 transition-all shadow-lg hover:shadow-white/20">
