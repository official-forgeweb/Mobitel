            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-2xl mx-auto text-center space-y-6 flex flex-col items-center">
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium text-dark tracking-tight leading-snug">
                        We're available on <br className="hidden sm:block" />
                        <span className="font-bold bg-clip-text text-transparent bg-gradient-to-r from-dark to-primary">Desktop and Mobile</span>.
                    </h2>

                    {/* Text Description */}
                    <p className="text-body text-[14px] md:text-[15px] leading-relaxed font-medium max-w-xl mx-auto">
                        Enjoy effortless access to our robust repair tracking platform on both your desktop and phone. Download the app today and keep your device health in your pocket!
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-6 w-full px-4">
                        ...
                        >
                            ...
                            <span className="font-bold text-[15px]">Download App</span>
                        </a>
