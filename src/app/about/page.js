            ...
            <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 px-4 text-center z-10">
                <div className="max-w-4xl mx-auto">
                    <h1 className="text-4xl md:text-6xl font-semibold text-dark mb-6 tracking-tight leading-tight">
                        We Bring Your <span className="text-primary">Devices Back to Life</span>.
                    </h1>
                    <p className="text-body text-lg md:text-xl font-light leading-relaxed max-w-2xl mx-auto mb-10">
                        Since 2014, Mobitel has been the trusted name in mobile device repair. We believe in transparent pricing, genuine parts, and treating every device like our own.
                    </p>
                </div>
            </section>
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        ...
                        <div className="w-full lg:w-1/2 space-y-6">
                            ...
                            <h2 className="text-3xl lg:text-4xl font-semibold text-dark tracking-tight leading-tight">
                                Quality Repairs,<br /> No Compromises.
                            </h2>
                            <div className="space-y-4 text-body font-light leading-relaxed text-lg">
                                <p>
                                    What started as a small workbench in a garage has grown into a state-of-the-art repair facility. We founded Mobitel because we were tired of seeing overpriced, low-quality repairs flooding the market.
                                </p>
                                <p>
                                    Our technicians are certified micro-soldering experts. Whether it's a simple screen swap or a complex motherboard data recovery, we approach every repair with military precision and a commitment to perfection. We don't just fix phones; we revive your connection to the world.
                                </p>
                            </div>
            ...
            <section className="py-24 relative z-10 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16 max-w-2xl mx-auto">
                        <h2 className="text-3xl md:text-5xl font-semibold text-dark mb-4 tracking-tight">The Mobitel Promise</h2>
                        <p className="text-body text-lg font-light">Why thousands of customers trust us with their most essential daily devices.</p>
                    </div>
